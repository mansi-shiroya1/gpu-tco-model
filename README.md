...
When does buying a 4× H100 server beat renting GPUs or calling a hosted Llama 70B API? This model solves for the break-even utilization of each option. Every default input is a dated public figure: GPU and server listings, cloud and API price pages, a vLLM throughput benchmark, EIA electricity data, CBRE colocation rates, Uptime Institute PUE, and hyperscaler 10-K depreciation schedules.

**Live demo:** `https://<your-username>.github.io/gpu-tco-model/`
...
- **The cheapest API is the toughest competitor.** For Llama 3.x 70B batch work, owning beats DeepInfra only above ~47% utilization. For interactive chat, it never does. Against Bedrock, Fireworks, and Together, owning wins above 7–23%.
...
|---|---|---|
| H100 80GB PCIe card | $27,500 | Midpoint of $25K–$30K range, Runpod H100 guide, Sept 2026 |
...
| Electricity | $0.2575/kWh | EIA Electric Power Monthly, California commercial, Apr 2026 |
| Colocation | $194.95/kW-month | CBRE national average lease rate (Silicon Valley: $180–$275) |
| Depreciation life | 5 years | Amazon 10-K: server life revised 6 → 5 years (2025). Microsoft and Alphabet: 6 |
| Rental rate | $3.29/GPU-hr | Lambda H100 PCIe list price. Median across 38 providers: $3.36 (GetDeploying, Sept 16, 2026) |
| Throughput | 3,400 / 1,400 output tok/s | GeneralCompute vLLM benchmark, Llama 3.1 70B FP8, 4× H100 SXM, Jun 2026 (batch at 256 concurrent; interactive at 64 users × ~22 tok/s) |
